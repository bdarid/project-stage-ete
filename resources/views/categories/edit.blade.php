            ...
            <form action="{{ route('categories.update', $categorie->id) }}" method="POST" class="bg-white p-8 rounded-xl shadow-lg border border-gray-100">
                ...
                <div class="grid grid-cols-1 gap-6 mb-6">
                    <div>
                        ...
                        <input type="text" name="nom_categorie" value="{{ old('nom_categorie', $categorie->nom_categorie) }}" class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500" required>
                    </div>
                    ...
                    <div>
                        ...
                        <textarea name="description_categorie" rows="4" class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">{{ old('description_categorie', $categorie->description_categorie) }}</textarea>
                    </div>
                </div>
